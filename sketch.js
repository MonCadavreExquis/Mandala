...
//   button = p.createButton("Générer une animation");
//   button.position(p.windowWidth*0.45,0);
//   button.size(p.windowWidth*0.15,p.windowWidth*0.02);
//   button.mousePressed(p.chooseImages);
//   button.hide();

//   buttonAnimation = p.createButton("Plus d'animation");
//   buttonAnimation.position(p.windowWidth*0.15,0);
//   buttonAnimation.size(p.windowWidth*0.2,p.windowWidth*0.02);
//   buttonAnimation.mousePressed(p.changeAnimation);
//   buttonAnimation.hide();
...
//         if(ani){
//         sinFirst = p.sin(sinAngle0)*2;
//         sinPointe = p.sin(sinAngle1)*1.5;
//         sinSecond = p.sin(sinAngle2)*2;
//       }
...
// col0 = p.color(p.random(255),0,p.random(255),p.random(100,255));
// col1 = p.color(0,p.random(255),p.random(255),p.random(100,255));
// col2 = p.color(p.random(255),p.random(255),0,p.random(100,255));
// col3 = p.color(p.random(255),0,p.random(255),p.random(100,255));
// col4 = p.color(0,p.random(255),p.random(255),p.random(100,255));
// col5 = p.color(p.random(255),p.random(255),0,p.random(100,255));
// col6 = p.color(p.random(255),0,p.random(255),p.random(100,255));
// col7 = p.color(0,p.random(255),p.random(255),p.random(100,255));
// col8 = p.color(p.random(255),p.random(255),0,p.random(100,255));
